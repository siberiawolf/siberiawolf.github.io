...
新用户注册购买[DigitalOcean][DO]的VPS，使用优惠码`2014SSD`有$10赠送，可用两个月。DO采取丧心病狂的低价竞争策略，每月$5即可享用全功能的SSD硬盘VPS，具体去看看[这里][DO]吧。
...
##完成
至此，一个完整的环境搭建就完成了，推荐试用[DigitalOcean][DO]的VPS看看，`2014SSD`的优惠码也可以试试看看有没有过期哦~
